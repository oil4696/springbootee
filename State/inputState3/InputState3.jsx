...
const hadleOnChange = (e) => {
    ...
    return <div>
        ...
        <input type="text" age="age" value={studentInputValue.age} onChange={hadleOnChange} />
        <input type="text" address="address" value={studentInputValue.address} onChange={hadleOnChange} />
